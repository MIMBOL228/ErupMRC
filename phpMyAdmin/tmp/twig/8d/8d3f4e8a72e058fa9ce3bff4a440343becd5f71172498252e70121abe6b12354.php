...
class __TwigTemplate_09daf7fe1bd3635c31bad29fcbfeaf38fa0df6793768936d39a424a191ca5d26 extends Twig_Template
{
        ...
        if ((($context["action"] ?? null) == "tbl_create.php")) {
            ...
            echo ":
                    <input type=\"text\"
                        ...
                        value=\"";
            // line 28
            echo twig_escape_filter($this->env, ((array_key_exists("table", $context)) ? (($context["table"] ?? null)) : ("")), "html", null, true);
            echo "\"
            ...
            <tr>
                <td>
                    <input type=\"text\"
                        ...
                        value=\"";
            // line 92
            echo twig_escape_filter($this->env, ((array_key_exists("comment", $context)) ? (($context["comment"] ?? null)) : ("")), "html", null, true);
            echo "\"
                        class=\"textfield\" />
                </td>
                <td width=\"25\">&nbsp;</td>
            ...
            echo "
                ...
                <td>
                    <input type=\"text\"
                        ...
                        value=\"";
            // line 119
            echo twig_escape_filter($this->env, ((array_key_exists("connection", $context)) ? (($context["connection"] ?? null)) : ("")), "html", null, true);
            echo "\"
...
";
    ...
    {
        return new Twig_Source("", "columns_definitions/column_definitions_form.twig", "C:\\Server\\data\\htdocs\\phpMyAdmin\\templates\\columns_definitions\\column_definitions_form.twig");
    }
}
