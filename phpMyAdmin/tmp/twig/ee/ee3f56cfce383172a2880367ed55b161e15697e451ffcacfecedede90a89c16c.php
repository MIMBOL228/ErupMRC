...
class __TwigTemplate_1e5f5d1d83b28f28770a440f5ee714e827c206ef3bebad503d310da7919275c0 extends Twig_Template
{
...
($context["show_column_comments"] ?? null)));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            ...
            if ($this->getAttribute(($context["comments_map"] ?? null), $this->getAttribute($context["row"], "Field", array(), "array"), array(), "array", true, true)) {
                ...
                // line 57
                echo "                ";
                $context["comments"] = twig_escape_filter($this->env, $this->getAttribute(($context["comments_map"] ?? null), $this->getAttribute($context["row"], "Field", array(), "array"), array(), "array"));
                // line 58
                echo "            ";
            }
            // line 59
            ...
            if (twig_in_filter(($context["field_name"] ?? null), ($context["columns_with_index"] ?? null))) {
                // line 66
                echo "                ";
                $context["displayed_field_name"] = (($context["displayed_field_name"] ?? null) . PhpMyAdmin\Util::getImage("b_key", _gettext("Index")));
                // line 69
                echo "            ";
            }
            // line 70
...
";
    ...
    {
        return new Twig_Source("", "table/structure/display_structure.twig", "C:\\Server\\data\\htdocs\\phpMyAdmin\\templates\\table\\structure\\display_structure.twig");
    }
}
